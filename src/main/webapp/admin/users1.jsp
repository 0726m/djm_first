...
<div class="layuimini-container" id="popUpdate" style="display: none;">
    <div class="layuimini-main">
        <form class="layui-form" action="" lay-filter="example">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="phone" lay-verify="required|telephone" lay-reqtext="必填项，不能为空" autocomplete="off" placeholder="请输入电话" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">折扣</label>
                <div class="layui-input-block">
                    <input type="text" name="zhekou" lay-verify="required|zhekou" lay-reqtext="必填项，不能为空" autocomplete="off" placeholder="请输入折扣" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">等级</label>
                <div class="layui-input-block">
                    <input type="text" name="grade" lay-verify="required|grade" lay-reqtext="必填项，不能为空" autocomplete="off" placeholder="请输入等级" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">积分</label>
                <div class="layui-input-block">
                    <input type="text" name="score" lay-verify="required|score" lay-reqtext="必填项，不能为空" autocomplete="off" placeholder="请输入积分" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '<%=Const.ROOT%>users/list?role=1',
            cols: [[
                ...
                {field: 'score', width: 100, title: '积分'},
                {field: 'grade', width: 100, title: '等级'},
                {field: 'zhekou', width: 100, title: '折扣'},
              ...
              form.on('submit(update)', function(message) {
                  ...
                  url:'<%=Const.ROOT%>users/update',
					...
					success : function(msg) {
						...
						if(msg.code=="0"){
							layer.msg(msg.msg, { icon: 6, time: 800},function(){
								//location.href="<%=Const.ROOT%>users.jsp";
