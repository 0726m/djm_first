    ...
    layui.use(['form', 'table'], function () {
        ...
        $(".data-add-btn").on("click", function () {
        	var addIndex=layer.open({
        		...
        		area: ['920px', '550px'],
        		type: 2, 
        		content: '<%=Const.ROOT%>admin/addnotice.jsp'
        	});
        });
              ...
              //表单初始赋值
               ...
               setFormValue(obj,data);    
                ...
                layer.confirm('真的删除行么', function (index) {
                    ...
                    $.getJSON('<%=Const.ROOT%>notice/delete',{'id':obj.data.id},function(msg) {
  						//console.log(msg);
  						if(msg.code=="0"){
              ...
              form.on('submit(update)', function(message) {
                  ...
                  url:'<%=Const.ROOT%>notice/update',
					...
					success : function(msg) {
						...
						if(msg.code=="0"){
							layer.msg(msg.msg, { icon: 6, time: 800},function(){
								//location.href="<%=Const.ROOT%>notice.jsp";
