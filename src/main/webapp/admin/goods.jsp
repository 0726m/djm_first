        ...
        <form class="layui-form" action="" lay-filter="aexample">
            ...
            <div class="layui-form-item">
			 ...
			 <div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="hidden" id="mp41" name="mp4" required>
						<button type="button" class="layui-btn" id="mp4test1">
							<i class="layui-icon">&#xe67c;</i>上传文件
						</button>
					</div>
			</div>
			<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="bofang" value="1"/>支持在线播放
                </div>
            </div>
			<div class="layui-form-item">
                <label class="layui-form-label">时长</label>
                <div class="layui-input-block">
                    <input type="number" name="times" lay-verify="required" lay-reqtext="必填项，不能为空" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">上映时间</label>
                <div class="layui-input-block">
                    <input type="text" id="startday1" name="startday" lay-verify="required" lay-reqtext="必填项，不能为空" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
             <div class="layui-form-item">
                <label class="layui-form-label">结束时间</label>
                <div class="layui-input-block">
                    <input type="text" id="endday1" name="endday" lay-verify="required" lay-reqtext="必填项，不能为空" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
        ...
        <form class="layui-form" action="" lay-filter="uexample">
        	...
        	<div class="layui-form-item">
              ...
              <div class="layui-form-item">
                <label class="layui-form-label">类型</label>
                <div class="layui-input-block">
                    <select name="kid" lay-verify="required" id="kid2"></select>
                </div>
            </div>
            <div class="layui-form-item">
					<label class="layui-form-label">主图</label>
			 ...
			 <div class="layui-form-item">
					<label class="layui-form-label">影片</label>
					<div class="layui-input-block">
						<input type="hidden" id="mp42" name="mp4" required>
						<button type="button" class="layui-btn" id="mp4test2">
							<i class="layui-icon">&#xe67c;</i>上传文件
						</button>
					</div>
			</div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">上映时间</label>
                <div class="layui-input-block">
                    <input type="text" id="startday2" name="startday" lay-verify="required" lay-reqtext="必填项，不能为空" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
             <div class="layui-form-item">
                <label class="layui-form-label">结束时间</label>
                <div class="layui-input-block">
                    <input type="text" id="endday2" name="endday" lay-verify="required" lay-reqtext="必填项，不能为空" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
					<label class="layui-form-label">介绍</label>
    ...
    layui.use(['form', 'table','laydate','upload'], function () {
        var $ = layui.jquery,
       	 ...
       	 $.getJSON("<%=Const.ROOT%>kind/jsonlist",function(data){
         	$("#kid1").html("<option value=''>请选择类型</option>");
         	$("#kid2").html("<option value=''>请选择类型</option>");
        ...
        table.render({
            elem: '#currentTableId',
            url: '<%=Const.ROOT%>goods/list',
            cols: [[
				{field:'id',hide:true,width: 0},
				{width: 50,style:'line-height:100px',templet:'#no',title: 'NO', sort: true},
                {field: 'name', width: 180, title: '名称'},
                {templet: '#kind', width: 180, title: '类型'},
                {templet: '#pic', width: 180, title: '主图'},
                {field: 'times', width: 180, title: '时长'},
                {field: 'startday', width: 180, title: '上映时间'},
                {field: 'endday', width: 180, title: '结束时间'},
        ...
        form.on('submit(add)', function (data) {
            $.post("<%=Const.ROOT%>goods/add",data.field,function(data){
            	if(data.code=="0"){
              ...
              //表单初始赋值
               ...
               editor2.txt.html(data.content);
                ...
                layer.confirm('真的删除行么', function (index) {
                    $.getJSON('<%=Const.ROOT%>goods/delete',{'id':obj.data.id},function(msg) {
  						if(msg.code=="0"){
