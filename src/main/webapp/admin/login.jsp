...
<head>
    ...
    <style>
        html, body {width: 100%;height: 100%;overflow: hidden}
         body {background: #009688;background-image: url("<%=Const.ROOT %>images/bg01.jpg");background-repeat: no-repeat;background-size:cover;}
            ...
            <form class="layui-form">
               ...
               <!--  <div class="layui-form-item">
                ...
                <div class="ayui-row layui-form-item">
                    ...
                    <button style="background-color: #2F4056" class="layui-btn layui-btn-fluid" lay-submit lay-filter="login">登 入</button>
                    </div>
                    <!-- <div class="layui-col-md6">
                    <button class="layui-btn layui-btn-fluid layui-btn-warm"  type="button" id="reg">用户注册</button>
                    </div>   -->
                </div>
                <div class="ayui-row layui-form-item">
...
<script src="<%=Const.ROOT %>admin/lib/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
<script src="<%=Const.ROOT %>admin/lib/layui-v2.5.4/layui.js" charset="utf-8"></script>
<script src="<%=Const.ROOT %>admin/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
    layui.use(['form'], function () {
          ...
          /*   $('.layui-container').particleground({
            ...
            $("#reg").on("click", function () {
            	var addIndex=layer.open({
            		...
            		area: ['700px', '420px'],
            		type: 2, 
            		content: '<%=Const.ROOT%>admin/adduser.jsp'
            	});
     ...
     // 监听添加操作
        ...
        form.on('submit(login)', function (data) {
            ...
            //ajax提交表单
            $.post("<%=Const.ROOT%>users/login",data,function(result){
            	if(result.code=="0"){
        			location.href="<%=Const.ROOT%>admin/index.jsp";
        		}else{
