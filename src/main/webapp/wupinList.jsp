          ...
          <div class="right-cont">
            ...
            <c:forEach items="${list }" var="v">
              <div class="item"  style="margin:0px 20px 20px 0px;">
                <div class="img">
                  <a href="<%=Const.ROOT%>wupin/detail?id=${v.id}"><img src="<%=Const.ROOT%>images/${v.pic}" alt="" style="width:280px;height:280px"></a>
                </div>
                <div class="text">
                  <p class="title">${v.name }</p>
                  <p class="price">
                    <span class="pri">所需积分:${v.jifen }分 </span>
                  </p>
                </div>
              </div>
             </c:forEach>
     ...
     mm = layui.mm;
      laypage.render({
          ...
          jump: function(obj, first){
              ...
              //首次不执行
              if(!first){
              	location.href="<%=Const.ROOT%>wupin/index?page="+page;
              }
          }
        });
